...
class MiniMaxH3EasyLatentUpscaler3D(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="MiniMaxH3EasyLatentUpscaler3D_SatoDive",
            display_name="MiniMax H3 Easy 3D Latent Upscale (Built-in) - SatoDive",
...
NODE_CLASS_MAPPINGS = {"MiniMaxH3EasyLatentUpscaler3D_SatoDive": MiniMaxH3EasyLatentUpscaler3D}
NODE_DISPLAY_NAME_MAPPINGS = {"MiniMaxH3EasyLatentUpscaler3D_SatoDive": "MiniMax H3 Easy 3D Latent Upscale (Built-in)"}
